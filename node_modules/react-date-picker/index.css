.react-date-field {
  ...
  margin-bottom: 1rem;		/* CUSTOM:	changed */
  }
  .react-date-field *,
...
.react-date-field__input {
  ...
  margin-top: 0px 	!important;		/* CUSTOM:	changed, so height of the input box isn't so enormous (due to parent div) */
  margin-bottom: 0px 	!important;		/* CUSTOM:	changed, so height of the input box isn't so enormous (due to parent div) */
  }
