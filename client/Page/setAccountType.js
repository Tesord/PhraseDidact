      ...
      if( Meteor.userId() ){
         ...
         this.content = (
            ...
            <div id="setAccountType-content" className="h-center">
               ...
               <div  id="set-learner"   className="_Theme_border_Default_ _Theme_register_Default_">
               ...
               <div  id="set-instructor"   className="_Theme_border_Default_ _Theme_register_Default_">
